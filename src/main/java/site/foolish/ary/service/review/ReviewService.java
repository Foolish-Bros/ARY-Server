...
public class ReviewService {
    ...
    public ReviewList crawling(String id, int times) throws IOException, ParseException, InterruptedException {
        ReviewList reviews = new ReviewList();

        Optional<ReviewList> nowReviews = reviewRepository.findById(id);
        ...
        switch (nowReviews.get().getMallName()) {
            case "coupang":
                ...
                break;
            case "11st":
                reviews = elevenCrawling(nowReviews.get(), times);
                break;
            case "auction":
                reviews = auctionCrawling(nowReviews.get(), times);
                break;
            default:
                break;
        }
...
//            log.info(String.valueOf(articles.get(1)));
     ...
     * 쿠팡 추가 크롤링
     */
    public ReviewList coupangCrawling(ReviewList reviewList, int times) throws IOException, InterruptedException, ParseException {
     ...
     * Auction 추가 크롤링
     */
    public ReviewList auctionCrawling(ReviewList reviewList, int times) throws IOException, InterruptedException, ParseException {
        String baseUrl = reviewList.getUrl();
